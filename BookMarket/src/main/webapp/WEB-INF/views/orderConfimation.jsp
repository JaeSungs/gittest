	...
	<div class="container">
		...
		<form:form modelAttribute="order" class="form-horizontal">
			<div class="well col-md-9 col-md-offset-2"
				style="background: #fafafe; padding: 20px">
				...
				<div class="row">
					<div class="col-md-6">
						<address>
							<strong>배송 주소</strong> <br> 성명 : ${order.shipping.name}<br>
							우편번호 : ${order.shipping.address.zipCode}<br> 주소 :
					...
					<div class="col-md-6 text-right">
						<p>
							<em>배송일: <fmt:formatDate type="date"
									value="${order.shipping.date}" /></em>
						</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-9">
						<address>
							<strong>청구주소</strong> <br> 성명 : ${order.customer.name}<br>
							우편번호 :${order.customer.address.zipCode}<br> 주소 :
							${order.customer.address.addressName}
							${order.customer.address.detailName}
							(${order.customer.address.country})<br> HP :
				...
				<div class="row">
					...
					<button type="submit" class="btn btn-success"
						name="_eventId_orderConfirmed">주문완료</button>
